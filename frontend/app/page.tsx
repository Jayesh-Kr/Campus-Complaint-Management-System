  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[85vh] text-center space-y-12 py-10">
      <div className="space-y-6 max-w-3xl">
        <h1 className="text-5xl md:text-7xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-neutral-100 to-neutral-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl mt-16 pt-16 border-t border-neutral-900">
        <div className="flex flex-col items-center text-center space-y-3 p-4">
          <div className="w-12 h-12 rounded-full border border-neutral-800 bg-neutral-900/50 flex items-center justify-center mb-2">
